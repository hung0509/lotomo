...
export default function POSScreen() {
  ...
  return (
    <div className="min-h-screen flex justify-center">
      <div className="w-full max-w-[420px] bg-white rounded-2xl shadow-lg overflow-hidden mb-20">
        {/* Header */}
        ...
        {/* Bottom */}
        {totalItems > 0 && (
          <div className="fixed bottom-[72px] left-1/2 -translate-x-1/2 w-full max-w-[420px] z-20">
            <div
              className="
        w-full
        bg-white
      ...
      "
            >
              ...
              <button
                ...
                className="w-full bg-[#038a42] text-white py-3 rounded-xl font-semibold mt-3"
              >
                Tiếp tục ({totalItems})
              </button>
            </div>
      ...
      {selectedProduct && (
        <div
          className="fixed z-30 inset-0 bg-black/40 flex items-end mb-20"
